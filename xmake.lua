...
function set_common()
    ...
    add_defines("_HAS_AUTO_PTR_ETC=1")
...
function set_dependencies()
    add_requires("zlib v1.2.13", "openexr 3.1.5", "libjpeg-turbo 2.1.4", "libpng v1.6.40", "xerces-c_custom 5052c90b067dcc347d58822b450897d16e2c31e5")
