...
#pragma warning( \
        disable : 4251)  // 'field' : class 'A' needs to have dll-interface to
                         // be used by clients of class 'B'
#pragma warning(disable : 4800)  // 'type' : forcing value to bool 'true' or
...
#include <memory.h>
#include <string.h>
#pragma intrinsic(memset, memcmp, memcpy, strlen, strcmp, strcpy, _strset, \
                      strcat, fabs, abs)
#endif
...
#pragma detect_mismatch("MTS_SPECTRUM_SAMPLES", \
                            MTS_XSTRINGIFY(SPECTRUM_SAMPLES))
#endif
