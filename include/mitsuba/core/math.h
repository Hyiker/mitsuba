...
namespace math
{
    ...
    template <typename Scalar>
    inline Scalar lerp(Scalar t, Scalar v1, Scalar v2)
    {
    ...
    template <typename Scalar>
    inline Scalar smoothStep(Scalar min, Scalar max, Scalar value)
    {
    ...
    template <typename Scalar>
    inline int floorToInt(Scalar value) { return (int)std::floor(value); }

    /// Integer ceil function (single precision)
    template <typename Scalar>
    inline int ceilToInt(Scalar value) { return (int)std::ceil(value); }
